...
## 12. Dashboard 多軸排序 chip 從垂直改水平排列〔2026-04-28 10:30:00〕
...
## 13. 跨頁作者 chip 點選後過濾結果為空（含空格 username 被 `\s+` 切壞）〔2026-04-28 10:50:00〕
...
## 14. Dashboard 文案統一:「你最常用的」→「最常使用」〔2026-04-28 10:55:00〕
...
## 15. FilterNav 文案精簡:「我的收藏」→「收藏」〔2026-04-28 11:05:00〕
...
## 16. 多頁作者 chip 行為統一（補齊 /skills、/scripts UI）〔2026-04-28 11:09:00〕
...
## 17. Skill / Script 上傳「檔案名稱」欄位顯示使用者命名（非原始檔名）〔2026-04-28 13:07:08〕
...
## 18. 為 Skill 增加「編輯名稱 / 描述」UI 入口 + 補上 Script 詳情頁〔2026-04-28 13:07:08〕

> 這條偏向「規格回補 + UI 一致性」, 同時跟 §17 配套（兩者都是 v1.3 接 SSO display name 後浮現的 UX 缺漏）, 故記在 fixed.md 而非 tasks。
